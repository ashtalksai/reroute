    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full md:w-1/2 flex flex-col min-h-screen bg-background px-8 py-10 md:px-16">
        ...
        <Link href="/" className="flex items-center gap-2.5 mb-12 self-start group">
          ...
          <span
            className="text-lg font-semibold font-display text-text-primary group-hover:text-accent transition-colors"
          >
            Reroute
          </span>
        </Link>
        ...
        <div className="mb-8">
          ...
          <p className="text-text-secondary font-sans text-sm">
            Start recovering flight compensation you&apos;re owed.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5 w-full max-w-md">
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="name" className="text-text-secondary text-xs uppercase tracking-wider font-sans">
              Full Name
            </Label>
            <Input
              id="name"
